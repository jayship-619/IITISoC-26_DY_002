...
* [Material Fingerprinting GitHub Repository](https://github.com/Material-Fingerprinting)

## Books & Textbooks
* *Nonlinear Solid Mechanics* — Gerhard A. Holzapfel
...
* [LAMMPS NPT ensemble (`fix npt`)](https://docs.lammps.org/fix_nh.html)
* [LAMMPS virial stress tensor (`compute stress/atom`)](https://docs.lammps.org/compute_stress_atom.html)
